  ...
  return (
    <div>
      ...
      <div className='center fade space-y-2 sm:space-y-3'>
        ...
        <p>An app that keeps track of your tasks effortlessly with our intuitive to-do list. Organize your day and boost productivity with ease.</p>
      </div>

      <main className='px-4 md:px-6 xl:px-72 py-3 space-y-3 sm:w-4/5 md:w-2/3 xl:w-[1440px] mx-auto fadeIn'>
        <h1 className='text-center'>Todo List</h1>
